...
export const outboundCallSchema = z.object({
  ...
  first_message_template: z.string().min(1).default('Halo, ada yang bisa saya bantu?'),
  system_prompt_template: z.string().min(1).default('Kamu adalah asisten AI yang ramah dan membantu. Berbicara dalam bahasa Indonesia dengan sopan.'),
